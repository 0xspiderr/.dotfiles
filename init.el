...
(doom! :input
       ...
       (indent-guides +fixed)     ; highlighted indent columns
       ...
       (go +lsp +treesiter)         ; the hipster dialect
       ...
       (python +lsp +pyenv +pyright +treesiter)            ; beautiful is better than ugly
